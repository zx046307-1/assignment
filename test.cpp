...
void test::initPoker()
{
    ...
    pokerF[0] = randNum[n++];  //產生1-52的隨機數
    pokerF[1] = randNum[n++];  //產生1-52的隨機數
    pokerL[0] = randNum[n++];  //產生1-52的隨機數
    pokerL[1] = randNum[n++];  //產生1-52的隨機數
...
void test::farmerAsk()
{
    ...
    {
        pokerF[pokerNumF++] = randNum[n++];   //產生1-52的隨機數
...
void test::landlordAsk()
{
    ...
    {
        pokerL[pokerNumL++] = randNum[n++];   //產生1-52的隨機數
        if (getSumL() > 21)
        {
            cout << "莊家的牌為" << getPokerL() << endl;
